...
DOCUMENTATION = """
module: resources_by_resourceid_sub_domain
short_description: Handle resource of type resources_by_resourceid_sub_domain
description: Handle resource of type resources_by_resourceid_sub_domain
options:
  resourceId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["subDomainId"] = {"type": "str", "operationIds": ["put"]}
    argument_spec["state"] = {"type": "str", "choices": ["put"]}
    argument_spec["resourceId"] = {"type": "str", "operationIds": ["put"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/sub-domain".format(
        **params
    )
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/sub-domain".format(
        **params
    )
