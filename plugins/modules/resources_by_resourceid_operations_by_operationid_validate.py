...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/operations/{operationId}/validate".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/operations/{operationId}/validate".format(
        **params
    )
