...
DOCUMENTATION = """
module: tag_keys_by_tagkey
short_description: Handle resource of type tag_keys_by_tagkey
description: Handle resource of type tag_keys_by_tagkey
options:
  autoIndexed:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["autoIndexed"] = {"type": "bool", "operationIds": ["patch", "put"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}".format(
        **params
