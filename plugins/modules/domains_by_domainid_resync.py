...
DOCUMENTATION = """
module: domains_by_domainid_resync
short_description: Handle resource of type domains_by_domainid_resync
description: Handle resource of type domains_by_domainid_resync
options:
  domainId:
    description:
...
def url(params):
    return (
        "https://{app_hostname}/bpocore/market/api/v1/domains/{domainId}/resync".format(
            **params
        )
    )
