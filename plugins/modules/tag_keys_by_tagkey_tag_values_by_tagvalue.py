...
DOCUMENTATION = """
module: tag_keys_by_tagkey_tag_values_by_tagvalue
short_description: Handle resource of type tag_keys_by_tagkey_tag_values_by_tagvalue
description: Handle resource of type tag_keys_by_tagkey_tag_values_by_tagvalue
options:
  description:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["value"] = {"type": "str", "operationIds": ["patch", "put"]}
    argument_spec["tagValue"] = {
        "type": "str",
        "operationIds": ["delete", "get", "head", "patch", "put"],
    }
    argument_spec["tagKey"] = {
        "type": "str",
        "operationIds": ["delete", "get", "head", "patch", "put"],
    }
    argument_spec["state"] = {
    ...
    argument_spec["key"] = {"type": "str", "operationIds": ["patch", "put"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values/{tagValue}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values/{tagValue}".format(
        **params
    ) + gen_args(
