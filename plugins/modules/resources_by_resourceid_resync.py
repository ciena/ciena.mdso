...
DOCUMENTATION = """
module: resources_by_resourceid_resync
short_description: Handle resource of type resources_by_resourceid_resync
description: Handle resource of type resources_by_resourceid_resync
options:
  full:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/resync".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/resync".format(
        **params
    ) + gen_args(
