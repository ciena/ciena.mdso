...
DOCUMENTATION = """
module: tenants_resync
short_description: Handle resource of type tenants_resync
description: Handle resource of type tenants_resync
options:
  state:
    choices:
    - post
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/tenants/resync".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/tenants/resync".format(
        **params
