...
DOCUMENTATION = """
module: sub_domains_by_subdomainid_containers
short_description: Handle resource of type sub_domains_by_subdomainid_containers
description: Handle resource of type sub_domains_by_subdomainid_containers
options:
  limit:
    description:
  ...
  recursive:
    description:
    - If true, returns indirect container subdomains as well, i.e., container of the
      container, etc.
    type: bool
  state:
    choices:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containers".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containers".format(
        **params
    ) + gen_args(
