...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}/result".format(
        **params
    )
...
async def _put(params, session):
    accepted_fields = ["_type", "reason", "result"]
    spec = {}
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}/result".format(
        **params
    )
