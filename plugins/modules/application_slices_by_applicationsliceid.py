...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}".format(
        **params
    ) + gen_args(
