...
DOCUMENTATION = """
module: resources_by_resourceid_reassemble
short_description: Handle resource of type resources_by_resourceid_reassemble
description: Handle resource of type resources_by_resourceid_reassemble
options:
  resourceId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/reassemble".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/reassemble".format(
        **params
    ) + gen_args(
