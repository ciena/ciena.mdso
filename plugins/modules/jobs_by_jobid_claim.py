...
DOCUMENTATION = """
module: jobs_by_jobid_claim
short_description: Handle resource of type jobs_by_jobid_claim
description: Handle resource of type jobs_by_jobid_claim
options:
  capabilities:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["jobId"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["executorUrl"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["capabilities"] = {"type": "list", "operationIds": ["post"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}/claim".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}/claim".format(
        **params
    )
