...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}/products".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}/products".format(
        **params
    ) + gen_args(
