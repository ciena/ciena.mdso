...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/type-artifacts/realm/validate".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/type-artifacts/realm/validate".format(
        **params
    ) + gen_args(
