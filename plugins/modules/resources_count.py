...
DOCUMENTATION = """
module: resources_count
short_description: Handle resource of type resources_count
description: Handle resource of type resources_count
options:
  domainId:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["domainId", "exactTypeId", "limit", "productId"]
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/count".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/count".format(
        **params
