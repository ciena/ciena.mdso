...
DOCUMENTATION = """
module: resources_by_resourceid_dependents
short_description: Handle resource of type resources_by_resourceid_dependents
description: Handle resource of type resources_by_resourceid_dependents
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependents".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependents".format(
        **params
    ) + gen_args(
