...
short_description: Handle resource of type resource_types
description: Handle resource of type resource_types
options:
  includeAbstract:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["includeAbstract", "limit", "offset", "p", "pageToken", "q"]
...
def prepare_argument_spec():
    ...
    argument_spec["includeAbstract"] = {"type": "bool", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resource-types".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resource-types".format(
        **params
