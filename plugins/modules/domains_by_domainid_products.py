...
DOCUMENTATION = """
module: domains_by_domainid_products
short_description: Handle resource of type domains_by_domainid_products
description: Handle resource of type domains_by_domainid_products
options:
  domainId:
    description:
    - Identifier of the domain whose product offerings are being queried
    type: str
  includeInactive:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["includeInactive", "limit", "offset", "pageToken", "q"]
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/domains/{domainId}/products".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/domains/{domainId}/products".format(
        **params
    ) + gen_args(
