...
short_description: Handle resource of type sharing_permissions
description: Handle resource of type sharing_permissions
options:
...
def prepare_argument_spec():
    ...
    argument_spec["visibleToSubTenants"] = {"type": "bool", "operationIds": ["post"]}
    argument_spec["updatableBySubTenants"] = {"type": "bool", "operationIds": ["post"]}
    ...
    argument_spec["deletableBySubTenants"] = {"type": "bool", "operationIds": ["post"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/sharing-permissions".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/sharing-permissions".format(
        **params
