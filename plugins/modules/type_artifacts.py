...
DOCUMENTATION = """
module: type_artifacts
short_description: Handle resource of type type_artifacts
description: Handle resource of type type_artifacts
options:
  limit:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/type-artifacts".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/type-artifacts".format(
        **params
