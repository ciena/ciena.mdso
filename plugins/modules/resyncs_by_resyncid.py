...
DOCUMENTATION = """
module: resyncs_by_resyncid
short_description: Handle resource of type resyncs_by_resyncid
description: Handle resource of type resyncs_by_resyncid
options:
  resyncId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["resyncId"] = {"type": "str", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resyncs/{resyncId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resyncs/{resyncId}".format(
        **params
