...
DOCUMENTATION = """
module: tag_keys_by_tagkey_tag_values
short_description: Handle resource of type tag_keys_by_tagkey_tag_values
description: Handle resource of type tag_keys_by_tagkey_tag_values
options:
  description:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["value"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["tagKey"] = {"type": "str", "operationIds": ["get", "head", "post"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values".format(
        **params
    ) + gen_args(
