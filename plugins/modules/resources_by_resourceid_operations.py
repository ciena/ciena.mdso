...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["beforeDate", "limit", "offset", "p", "pageToken", "q"]
...
def prepare_argument_spec():
    ...
    argument_spec["resourceId"] = {
        "type": "str",
        "operationIds": ["delete", "get", "head", "post"],
    }
    ...
    argument_spec["beforeDate"] = {"type": "str", "operationIds": ["delete"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/operations".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/operations".format(
        **params
    ) + gen_args(
