...
DOCUMENTATION = """
module: application_slices_by_applicationsliceid_extended_sub_domains
short_description: Handle resource of type application_slices_by_applicationsliceid_extended_sub_domains
description: Handle resource of type application_slices_by_applicationsliceid_extended_sub_domains
options:
  applicationSliceId:
    description:
    - Identifies the application slice whose extended subdomains are to be listed
    type: str
  limit:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/extended-sub-domains".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/extended-sub-domains".format(
        **params
    ) + gen_args(
