...
DOCUMENTATION = """
module: resources_by_resourceid_audit
short_description: Handle resource of type resources_by_resourceid_audit
description: Handle resource of type resources_by_resourceid_audit
options:
  resourceId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/audit".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/audit".format(
        **params
    ) + gen_args(
