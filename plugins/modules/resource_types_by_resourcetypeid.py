...
DOCUMENTATION = """
module: resource_types_by_resourcetypeid
short_description: Handle resource of type resource_types_by_resourcetypeid
description: Handle resource of type resource_types_by_resourcetypeid
options:
  resourceTypeId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}".format(
        **params
    ) + gen_args(
