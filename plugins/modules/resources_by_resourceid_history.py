...
DOCUMENTATION = """
module: resources_by_resourceid_history
short_description: Handle resource of type resources_by_resourceid_history
description: Handle resource of type resources_by_resourceid_history
options:
  after:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["after", "before", "limit", "offset", "pageToken"]
...
def prepare_argument_spec():
    ...
    argument_spec["before"] = {"type": "str", "operationIds": ["get", "head"]}
    argument_spec["after"] = {"type": "str", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/history".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/history".format(
        **params
    ) + gen_args(
