...
DOCUMENTATION = """
module: application_slices_by_applicationsliceid_parents
short_description: Handle resource of type application_slices_by_applicationsliceid_parents
description: Handle resource of type application_slices_by_applicationsliceid_parents
options:
  applicationSliceId:
    description:
    - Identifies the application slice whose parent slices are to be listed
    type: str
  limit:
    description:
  ...
  recursive:
    description:
    - If true, returns indirect parent application-slices as well, i.e., parent of
      the parent, etc.
    type: bool
  state:
    choices:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/parents".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/parents".format(
        **params
    ) + gen_args(
