...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/sharing-permissions/{sharingPermissionId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/sharing-permissions/{sharingPermissionId}".format(
        **params
    ) + gen_args(
