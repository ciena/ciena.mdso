...
DOCUMENTATION = """
module: application_slices_by_applicationsliceid_remove_extended_sub_domains
short_description: Handle resource of type application_slices_by_applicationsliceid_remove_extended_sub_domains
description: Handle resource of type application_slices_by_applicationsliceid_remove_extended_sub_domains
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/remove-extended-sub-domains".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/remove-extended-sub-domains".format(
        **params
    )
