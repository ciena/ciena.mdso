...
DOCUMENTATION = """
module: tenants_by_tenantid
short_description: Handle resource of type tenants_by_tenantid
description: Handle resource of type tenants_by_tenantid
options:
  state:
    choices:
    - get
...
def prepare_argument_spec():
    ...
    argument_spec["tenantId"] = {"type": "str", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/tenants/{tenantId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/tenants/{tenantId}".format(
        **params
