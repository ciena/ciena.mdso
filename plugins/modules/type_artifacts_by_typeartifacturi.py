...
DOCUMENTATION = """
module: type_artifacts_by_typeartifacturi
short_description: Handle resource of type type_artifacts_by_typeartifacturi
description: Handle resource of type type_artifacts_by_typeartifacturi
options:
  state:
    choices:
    - get
...
def prepare_argument_spec():
    ...
    argument_spec["typeArtifactUri"] = {"type": "str", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/type-artifacts/{typeArtifactUri}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/type-artifacts/{typeArtifactUri}".format(
        **params
    ) + gen_args(
