...
DOCUMENTATION = """
module: ping
short_description: Handle resource of type ping
description: Handle resource of type ping
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/ping".format(**params)
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/ping".format(
        **params
