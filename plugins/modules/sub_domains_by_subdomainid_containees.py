...
DOCUMENTATION = """
module: sub_domains_by_subdomainid_containees
short_description: Handle resource of type sub_domains_by_subdomainid_containees
description: Handle resource of type sub_domains_by_subdomainid_containees
options:
  limit:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containees".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containees".format(
        **params
    ) + gen_args(
