...
DOCUMENTATION = """
module: resources_by_resourceid_dependencies
short_description: Handle resource of type resources_by_resourceid_dependencies
description: Handle resource of type resources_by_resourceid_dependencies
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependencies".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependencies".format(
        **params
    ) + gen_args(
