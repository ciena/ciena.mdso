...
DOCUMENTATION = """
module: sub_domains_by_subdomainid_add_resources
short_description: Handle resource of type sub_domains_by_subdomainid_add_resources
...
def prepare_argument_spec():
    ...
    argument_spec["resources"] = {"type": "list", "operationIds": ["post"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/add-resources".format(
        **params
    )
...
async def _post(params, session):
    accepted_fields = ["resources"]
    spec = {}
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{app_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/add-resources".format(
        **params
    )
