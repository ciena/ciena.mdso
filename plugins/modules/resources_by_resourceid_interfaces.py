...
DOCUMENTATION = """
module: resources_by_resourceid_interfaces
short_description: Handle resource of type resources_by_resourceid_interfaces
description: Handle resource of type resources_by_resourceid_interfaces
options:
  p:
    description:
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/interfaces".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resources/{resourceId}/interfaces".format(
        **params
    ) + gen_args(
