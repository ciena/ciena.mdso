...
DOCUMENTATION = """
module: relationships_unresolved
short_description: Handle resource of type relationships_unresolved
description: Handle resource of type relationships_unresolved
options:
  limit:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["limit", "offset", "pageToken", "q", "resourceId"]
...
def url(params):
    return (
        "https://{app_hostname}/bpocore/market/api/v1/relationships/unresolved".format(
            **params
        )
    )
