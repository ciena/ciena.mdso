...
DOCUMENTATION = """
module: jobs_by_jobid
short_description: Handle resource of type jobs_by_jobid
description: Handle resource of type jobs_by_jobid
options:
  jobId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["jobId"] = {"type": "str", "operationIds": ["get", "head"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}".format(**params)
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/jobs/{jobId}".format(
        **params
