...
DOCUMENTATION = """
module: application_slices
short_description: Handle resource of type application_slices
description: Handle resource of type application_slices
options:
  description:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["sliceRole"] = {"type": "dict", "operationIds": ["post"]}
    argument_spec["requiredAppSlicesIds"] = {"type": "list", "operationIds": ["post"]}
    ...
    argument_spec["ownerTenantId"] = {"type": "str", "operationIds": ["post"]}
    ...
    argument_spec["isDefault"] = {"type": "bool", "operationIds": ["post"]}
    argument_spec["holderTenantId"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["extendable"] = {"type": "bool", "operationIds": ["post"]}
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/application-slices".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/application-slices".format(
        **params
