...
DOCUMENTATION = """
module: application_slices_by_applicationsliceid_add_extended_sub_domains
short_description: Handle resource of type application_slices_by_applicationsliceid_add_extended_sub_domains
description: Handle resource of type application_slices_by_applicationsliceid_add_extended_sub_domains
options:
  applicationSliceId:
    description:
    - Identifies the application slice for which extended subdomains are to be added
    type: str
  state:
    choices:
    - post
