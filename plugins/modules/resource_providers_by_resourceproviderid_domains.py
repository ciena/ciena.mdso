...
DOCUMENTATION = """
module: resource_providers_by_resourceproviderid_domains
short_description: Handle resource of type resource_providers_by_resourceproviderid_domains
description: Handle resource of type resource_providers_by_resourceproviderid_domains
options:
  limit:
    description:
  ...
  resourceProviderId:
    description:
    - Identifier of the resource provuder whose domains are being queried
    type: str
  state:
    choices:
    - get
...
def url(params):
    return "https://{app_hostname}/bpocore/market/api/v1/resource-providers/{resourceProviderId}/domains".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{app_hostname}/bpocore/market/api/v1/resource-providers/{resourceProviderId}/domains".format(
        **params
    ) + gen_args(
